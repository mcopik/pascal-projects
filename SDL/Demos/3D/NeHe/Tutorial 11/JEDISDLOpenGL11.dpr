...
var
  ...
  points : array[0..44] of array[0..44] of array[0..2] of GLfloat ;    // The Points On The Grid Of Our "Wave" */
  wiggle_count : integer = 0; // Counter Used To Control How Fast Flag Waves */
  hold : GLfloat;            // Temporarily Holds A Floating Point Value */
...
begin
  ...
  TextureImage := SDL_LoadBMP('images/tim.bmp');
