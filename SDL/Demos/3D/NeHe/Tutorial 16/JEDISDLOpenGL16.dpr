...
{ All Rights Reserved.                                             }
{                                                                  }
{ The original files are : lesson16.c                              }
{                                                                  }
...
var
  ...
  texture : array[ 0..NUM_TEXTURES - 1 ] of GLuint; // Storage For 3 Textures ( NEW )
...
begin
  ...
  TextureImage := SDL_LoadBMP('images/crate.bmp');
...
begin
  ...
  SDL_WM_SetCaption( 'Jeff Molofee''s OpenGL Code Tutorial 16 using JEDI-SDL', nil
    );
