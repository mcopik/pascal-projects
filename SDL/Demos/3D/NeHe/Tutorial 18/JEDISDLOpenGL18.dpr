...
{ All Rights Reserved.                                             }
{                                                                  }
{ The original files are : lesson18.c                              }
{                                                                  }
{ The original Pascal code is : JEDISDLOpenGL18.dpr                }
...
var
  ...
  part1 : GLdouble ;    // Start Of Disc         */
  part2 : GLdouble ;    // End Of Disc           */
  p1 : GLdouble  = 0;   // Increase 1            */
  p2 : GLdouble  = 1;   // Increase 2            */
  ...
  quadric : PGLUquadricObj;     // Storage For Our Quadratic Objects */
  objectt : GLuint  = 5;            // Which Object To Draw              */

  filter : GLuint ;                // Which Filter To Use               */          */
  texture : array[0..NUM_TEXTURES-1] of GLuint; // Storage For Our Font Texture             */
...
begin
  ...
  TextureImage := SDL_LoadBMP('images/wall.bmp');
...
begin
  case keysym.sym of
    ...
    begin
      {* ' ' key was pressed
       * this toggles the objects
       *}
      inc( objectt );
      objectt := objectt mod 6;
    end;
  ...
  glRotatef( yrot, 0.0, 1.0, 0.0); // Rotate On The Y Axis By yrot */
   ...
   // Determine what object to draw */
	...
	begin
	    ...
	    gluPartialDisk( quadric, 0.5, 1.5, 32, 32,
			    part1, part2 - part1 );
        end;
	end;
