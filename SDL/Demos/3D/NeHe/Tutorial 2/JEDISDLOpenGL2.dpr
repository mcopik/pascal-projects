...
{ All Rights Reserved.                                             }
{                                                                  }
{ The original files are : lesson02.c                              }
{                                                                  }
{ The original Pascal code is : JEDISDLOpenGL2.dpr                 }
...
begin
  ...
  SDL_WM_SetCaption( 'Jeff Molofee''s OpenGL Code Tutorial 2 using JEDI-SDL', nil
    );
