...
{ All Rights Reserved.                                             }
{                                                                  }
{ The original files are : lesson03.c                              }
{                                                                  }
{ The original Pascal code is : JEDISDLOpenGL3.dpr                 }
...
begin
  ...
  SDL_WM_SetCaption( 'Jeff Molofee''s OpenGL Code Tutorial 3 using JEDI-SDL', nil
    );
