...
const
  ...
  LightPos: array[0..3] of GLFloat = (0.0, 5.0, 10.0, 1.0);
  LightAmbient: array[0..3] of GLFloat = (0.2, 0.2, 0.2, 1.0);
  LightDiffuse: array[0..3] of GLFloat = (0.3, 0.3, 0.3, 1.0);
  LightSpecular: array[0..3] of GLFloat = (0.8, 0.8, 0.8, 1.0);
...
begin
  ...
  ElapsedTime := (LastTime + ElapsedTime) shr 1; // Same as div 2 but faster
  glClear(GL_COLOR_BUFFER_BIT or GL_DEPTH_BUFFER_BIT);
