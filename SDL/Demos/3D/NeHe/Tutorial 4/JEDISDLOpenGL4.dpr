...
{ All Rights Reserved.                                             }
{                                                                  }
{ The original files are : lesson04.c                              }
{                                                                  }
{ The original Pascal code is : JEDISDLOpenGL4.dpr                 }
...
begin
  ...
  glBegin( GL_TRIANGLES  );         // Drawing Using Triangles
    ...
    glVertex3f( -1.0, -1.0,  0.0 ); // Left Of Triangle
    glColor3f(   0.0,  0.0,  1.0 ); // Blue
    glVertex3f(  1.0, -1.0,  0.0 ); // Right Of Triangle
  ...
  glBegin( GL_QUADS );              // Draw A Quad
    glVertex3f(  1.0,  1.0,  0.0 ); // Top Right Of The Quad
    glVertex3f( -1.0,  1.0,  0.0 ); // Top Left Of The Quad
    glVertex3f( -1.0, -1.0,  0.0 ); // Bottom Left Of The Quad
    glVertex3f(  1.0, -1.0,  0.0 ); // Bottom Right Of The Quad
...
begin
  ...
  SDL_WM_SetCaption( 'Jeff Molofee''s OpenGL Code Tutorial 4 using JEDI-SDL', nil
    );
