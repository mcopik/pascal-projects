...
{ All Rights Reserved.                                             }
{                                                                  }
{ The original files are : lesson08.c                              }
{                                                                  }
{ The original Pascal code is : JEDISDLOpenGL8.dpr                 }
...
var
  ...
  filter : GLuint;     // Which Filter To Use  ( NEW )
  texture : array[0..2] of GLuint; // Storage For 3 Textures ( NEW )
...
begin
  ...
  TextureImage := SDL_LoadBMP('images/glass.bmp');
...
begin
  ...
  SDL_WM_SetCaption( 'Jeff Molofee''s OpenGL Code Tutorial 8 using JEDI-SDL', nil
    );
