...
Modified by: Stojkovic Igor
Email: stojkovic@galeb.etf.bg.ac.yu
       jimyiigor@ptt.yu
July 28, 2004
...
begin
  ...
  if Kind in [tkEnumeration,tkInteger,tkChar,tkSet] then
    Result := Result and (PropInfo.Default<>AsInteger);
end;
