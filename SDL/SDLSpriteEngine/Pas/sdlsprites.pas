...
{************************************************************************
(*
  $Id: sdlsprites.pas,v 1.4 2006/11/25 23:33:13 savage Exp $
...
(*
  ...
  Revision 1.4  2006/11/25 23:33:13  savage
  Use destructor instead of Free.
...
type
  ...
  public
    ...
    constructor Create( const _Image : string; Width, Height : integer; UseAlpaChannel: boolean = false);
    destructor Destroy; override; // remove sprite from screen, result=-2 then background surface is lost
...
constructor TSprite.Create( const _Image : string; Width, Height : integer; UseAlpaChannel: boolean );
var
  Temp : PSDL_Surface;
begin
  inherited Create;
