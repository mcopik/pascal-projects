...
{******************************************************************************}
{
  $Id: sdl_net.pas,v 1.14 2007/12/05 22:54:09 savage Exp $
...
{
  $Log: sdl_net.pas,v $
  Revision 1.14  2007/12/05 22:54:09  savage
  Better Mac OS X support for Frameworks.

  Revision 1.13  2007/05/29 21:31:53  savage
  Changes as suggested by Almindor for 64bit compatibility.

  Revision 1.12  2007/05/20 20:31:39  savage
  Initial Changes to Handle 64 Bits

  Revision 1.11  2006/12/02 00:17:22  savage
  Updated to latest version

  Revision 1.10  2005/04/10 11:48:33  savage
  Changes as suggested by Michalis, thanks.

  Revision 1.9  2005/01/05 01:47:11  savage
  Changed LibName to reflect what MacOS X should have. ie libSDL*-1.2.0.dylib respectively.

  Revision 1.8  2005/01/04 23:14:56  savage
...
{$IFDEF UNIX}
{$IFDEF DARWIN}
  SDLNetLibName = 'libSDL_net-1.2.0.dylib';
{$ELSE}
  {$IFDEF FPC}
    SDLNetLibName = 'libSDL_net.so';
  {$ELSE}
    SDLNetLibName = 'libSDL_net-1.2.so.0';
  {$ENDIF}
{$ENDIF}
{$ENDIF}
