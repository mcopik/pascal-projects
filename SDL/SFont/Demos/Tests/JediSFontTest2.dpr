program JediSFontTest2;
{******************************************************************}
{                                                                  }
{       Borland Delphi SFont Test2                                 }
...
{ All Rights Reserved.                                             }
{                                                                  }
{ The original files are : test2.c                                 }
{                                                                  }
{ The original Pascal code is : JediSFontTest2.dpr                 }
...
{ Description                                                      }
{ -----------                                                      }
{  Shows how to load a bitmap font and display text in different   }
{  parts of the screen.                                            }
{                                                                  }
...
begin
  ...
  SDL_WM_SetCaption( 'SFont Test2', 'SFont' );
  Text := 'You can modify this text!';

  // Load the font - You don't have to use the IMGlib for this
  Font_ := IMG_Load( 'images/24P_Arial_NeonYellow.png' );
  
  // Prepare the font for use
  SFont_InitFont( Font_ );

  // a simple text blit to (0/0)
  SFont_Write( screen_, 0, 0, 'Top Left' );

  // License Info...
  SFont_Write( screen_, 100, 120, 'SFont by Karl Bartel is GPL''ed!' );
  SFont_Write( screen_, 100, 150, 'Pascal version by Jason Farmer' );
  ...
  SFont_Input( screen_, 100, 80, 500, text );
